...
checkpoints = [143000]#get_ckpts("sparse")[:]
...
for ckpt in checkpoints:
    ...
    model = load_model(BASE_MODEL, VARIANT, ckpt, CACHE, device, large_model=True)
    ...
    file_path = f'/mnt/hdd-0/circuits-over-time/results/components/{MODEL_SHORTNAME}/whole_model_cspa.pt'
